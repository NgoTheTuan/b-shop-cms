...
const Analytics = ({ dataStatus, totalOrder }) => {
  const data = {
    series: dataStatus,
    categories: ["Thành công", "Đang chờ", "Huỷ đơn"],
  };
  ...
  const chartOptions = {
    ...
    labels: ["Thành công", "Đang chờ", "Huỷ đơn"],
    plotOptions: {
      radialBar: {
        dataLabels: {
          name: { show: false },
  ...
  return (
    ...
    >
      <FlexBox alignItems="center" justifyContent="space-between">
        <H5>Trạng thái đơn hàng đã tạo ({totalOrder})</H5>
      </FlexBox>
